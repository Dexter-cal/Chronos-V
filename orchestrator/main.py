...
GENERATOR_MAP = {
    ...
    "fake_magic": (badfiles_generator.generate_fake_magic_bytes, "fake_magic.gif"),
    "csv_html": (badfiles_generator.generate_csv_with_html_payload, "csv_xss.csv"),
    "rtf_ole": (badfiles_generator.generate_rtf_with_ole_link, "ole.rtf"),
}
...
def run_all_scanners(filepath):
    ...
    if filename.endswith(".xml"):
        ...
        results.append(security_scanner.scan_csv_for_html(filepath))
        ...
        results.append(security_scanner.scan_for_fake_magic_bytes(filepath))
    elif filename.endswith(".rtf"):
        results.append(security_scanner.scan_rtf_for_ole(filepath))
